...
func (q *Queries) ClearSelfConfigSeedInputs(ctx context.Context) error {
	_, err := q.db.Exec(ctx, clearSelfConfigSeedInputs)
	return err
}
...
func (q *Queries) CountSelfConfigCompletedGeneration(ctx context.Context, generation int64) (int64, error) {
	row := q.db.QueryRow(ctx, countSelfConfigCompletedGeneration, generation)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
func (q *Queries) CountSelfConfigRootFinalizationBlockers(ctx context.Context) (int64, error) {
	row := q.db.QueryRow(ctx, countSelfConfigRootFinalizationBlockers)
	var count int64
	err := row.Scan(&count)
	return count, err
}
...
// hikyo:instance-scoped
func (q *Queries) FenceSelfConfigTopologyLease(ctx context.Context, expiresAt pgtype.Timestamptz) error {
	_, err := q.db.Exec(ctx, fenceSelfConfigTopologyLease, expiresAt)
	return err
}
...
func (q *Queries) GetLatestSelfConfigTopology(ctx context.Context) (string, error) {
	row := q.db.QueryRow(ctx, getLatestSelfConfigTopology)
...
func (q *Queries) GetSelfConfigClock(ctx context.Context) (string, error) {
	row := q.db.QueryRow(ctx, getSelfConfigClock)
...
func (q *Queries) GetSelfConfigPreviousRevision(ctx context.Context) (int64, error) {
	row := q.db.QueryRow(ctx, getSelfConfigPreviousRevision)
	var revision int64
...
func (q *Queries) GetSelfConfigRollout(ctx context.Context, jobID string) (SelfConfigRollout, error) {
	row := q.db.QueryRow(ctx, getSelfConfigRollout, jobID)
...
func (q *Queries) InsertSelfConfigRollout(ctx context.Context, arg InsertSelfConfigRolloutParams) (int64, error) {
	result, err := q.db.Exec(ctx, insertSelfConfigRollout,
		arg.JobID,
		arg.EnrollmentID,
		arg.Incarnation,
		arg.PlanDigest,
...
func (q *Queries) ListSelfConfigSeedInputs(ctx context.Context) ([]ListSelfConfigSeedInputsRow, error) {
	rows, err := q.db.Query(ctx, listSelfConfigSeedInputs)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
...
func (q *Queries) NextSelfConfigRolloutSequence(ctx context.Context, enrollmentID string) (int64, error) {
	row := q.db.QueryRow(ctx, nextSelfConfigRolloutSequence, enrollmentID)
	var sequence int64
...
func (q *Queries) PutSelfConfigSeedAttestation(ctx context.Context, arg PutSelfConfigSeedAttestationParams) error {
	_, err := q.db.Exec(ctx, putSelfConfigSeedAttestation,
		arg.NodeID,
		arg.SchemaVersion,
		arg.Fingerprint,
		arg.HeartbeatAt,
...
func (q *Queries) PutSelfConfigSeedInput(ctx context.Context, arg PutSelfConfigSeedInputParams) error {
	_, err := q.db.Exec(ctx, putSelfConfigSeedInput,
		arg.NodeID,
		arg.OwnerInstanceID,
		arg.Incarnation,
		arg.Fingerprint,
...
func (q *Queries) UpdateSelfConfigRollout(ctx context.Context, arg UpdateSelfConfigRolloutParams) (int64, error) {
	result, err := q.db.Exec(ctx, updateSelfConfigRollout,
		arg.PlanDigest,
		arg.CommandJson,
		arg.ResponseJson,
		arg.ExternalPhase,
