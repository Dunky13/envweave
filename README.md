...
| [`CAP-PRIVACY-OPERATIONS`](./docs/status/README.md#cap-privacy-operations) Self-hosted privacy operations | Host-local subject export, correction, restriction, release, identity erasure and restore receipt replay; bounded audited audit retention; doctor evidence collection and operator privacy documentation |
